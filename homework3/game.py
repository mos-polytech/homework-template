...
def handle_user_input():
    ...
    while move not in allowed_moves:
        move = input('Следующий шаг(используйте клавиши wasd для управления \n')
    return move
...
def main():
    ...
    while not is_game_finished(field):
        ...
        try:
            ...
            print('Так нельзя двигаться')
    print('Прекрасная работа, вы выйграли!')
    print('Количество ваших ходов: ', counter)
    print_field(field)
